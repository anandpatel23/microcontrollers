// ======================================================================
// interleaveBits.v generated from TopDesign.cysch
// 07/09/2015 at 14:29
...
// TCPWM_P4_v2_0(Clock_CheckTolerance=true, Clock_desired_freq=12, Clock_desired_freq_unit=6, Clock_divisor=1, Clock_FractDividerDenominator=0, Clock_FractDividerNumerator=0, Clock_FractDividerUsed=false, Clock_is_direct=false, Clock_is_divider=false, Clock_is_freq=true, Clock_minus_tolerance=5, Clock_ph_align_clock_id=, Clock_ph_align_clock_name=, Clock_plus_tolerance=5, Clock_source_clock_id=, Clock_source_clock_name=, PinVisibility_index=false, PinVisibility_kill=false, PinVisibility_phiA=false, PinVisibility_phiB=false, PinVisibility_switch=false, PWMCompare=500, PWMCompareBuf=65535, PWMCompareSwap=0, PWMCountMode=3, PWMCountPresent=false, PWMDeadTimeCycle=0, PWMInterruptMask=1, PWMKillEvent=0, PWMLinenSignal=0, PWMLineSignal=0, PWMMode=4, PWMPeriod=1000, PWMPeriodBuf=65535, PWMPeriodSwap=0, PWMPrescaler=0, PWMReloadMode=0, PWMReloadPresent=false, PWMRunMode=0, PWMSetAlign=0, PWMStartMode=0, PWMStartPresent=false, PWMStopEvent=0, PWMStopMode=0, PWMStopPresent=false, PWMSwitchMode=0, PWMSwitchPresent=false, QuadEncodingModes=0, QuadIndexMode=0, QuadIndexPresent=false, QuadInterruptMask=1, QuadPhiAMode=3, QuadPhiBMode=3, QuadStopMode=0, QuadStopPresent=false, TCCaptureMode=0, TCCapturePresent=false, TCCompare=65535, TCCompareBuf=65535, TCCompareSwap=0, TCCompCapMode=2, TCCountingModes=0, TCCountMode=3, TCCountPresent=false, TCInterruptMask=1, TCPeriod=65535, TCPrescaler=0, TCPWMCapturePresent=false, TCPWMConfig=7, TCPWMCountPresent=false, TCPWMReloadPresent=false, TCPWMStartPresent=false, TCPWMStopPresent=false, TCReloadMode=0, TCReloadPresent=false, TCRunMode=0, TCStartMode=0, TCStartPresent=false, TCStopMode=0, TCStopPresent=false, TermMode_capture=0, TermMode_cc=0, TermMode_clock=0, TermMode_count=0, TermMode_interrupt=0, TermMode_line=0, TermMode_line_n=0, TermMode_ov=0, TermMode_reload=0, TermMode_start=0, TermMode_stop=0, TermMode_un=0, TermModeStates=, TermVisibility_capture=false, TermVisibility_cc=true, TermVisibility_clock=true, TermVisibility_count=false, TermVisibility_interrupt=true, TermVisibility_line=true, TermVisibility_line_n=true, TermVisibility_ov=true, TermVisibility_reload=false, TermVisibility_start=false, TermVisibility_stop=false, TermVisibility_un=true, CY_COMPONENT_NAME=TCPWM_P4_v2_0, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=PWM_2, CY_INSTANCE_SHORT_NAME=PWM_2, CY_MAJOR_VERSION=2, CY_MINOR_VERSION=0, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  3.2, INSTANCE_NAME=PWM_2, )
...
// LPComp_P4_v2_0(DBGW_LPCOMP_IP_V0=true, DBGW_LPCOMP_IP_V2=false, DigitalFilter=0, Hysteresis=0, Interrupt=3, InterruptEnabled=false, LegacyOutputPosition=false, OutputMode=0, Speed=1, CY_COMPONENT_NAME=LPComp_P4_v2_0, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=Comp_0, CY_INSTANCE_SHORT_NAME=Comp_0, CY_MAJOR_VERSION=2, CY_MINOR_VERSION=0, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  3.2, INSTANCE_NAME=Comp_0, )
module LPComp_P4_v2_0_5 (
    Vplus,
    Vminus,
    CmpOut,
    intr);
...
// LPComp_P4_v2_0(DBGW_LPCOMP_IP_V0=true, DBGW_LPCOMP_IP_V2=false, DigitalFilter=0, Hysteresis=1, Interrupt=3, InterruptEnabled=false, LegacyOutputPosition=false, OutputMode=0, Speed=1, CY_COMPONENT_NAME=LPComp_P4_v2_0, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=Comp_1, CY_INSTANCE_SHORT_NAME=Comp_1, CY_MAJOR_VERSION=2, CY_MINOR_VERSION=0, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  3.2, INSTANCE_NAME=Comp_1, )
module LPComp_P4_v2_0_6 (
    Vplus,
    Vminus,
    CmpOut,
    intr);
...
// DieTemp_P4_v1_0(CY_COMPONENT_NAME=DieTemp_P4_v1_0, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=DieTemp, CY_INSTANCE_SHORT_NAME=DieTemp, CY_MAJOR_VERSION=1, CY_MINOR_VERSION=0, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  3.2, INSTANCE_NAME=DieTemp, )
module DieTemp_P4_v1_0_8 (
    temp);
    inout       temp;
    electrical  temp;
...
// OpAmp_P4_v1_10(Compensation=3, DeepSleepSupport=false, Mode=1, OutputCurrent=0, Power=3, CY_COMPONENT_NAME=OpAmp_P4_v1_10, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=ADC_2_Buffer, CY_INSTANCE_SHORT_NAME=ADC_2_Buffer, CY_MAJOR_VERSION=1, CY_MINOR_VERSION=10, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  3.2, INSTANCE_NAME=ADC_2_Buffer, )
module OpAmp_P4_v1_10_9 (
    Vplus,
    Vout,
    Vminus);
    inout       Vplus;
...
// OpAmp_P4_v1_10(Compensation=3, DeepSleepSupport=false, Mode=1, OutputCurrent=0, Power=3, CY_COMPONENT_NAME=OpAmp_P4_v1_10, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=ADC_3_Buffer, CY_INSTANCE_SHORT_NAME=ADC_3_Buffer, CY_MAJOR_VERSION=1, CY_MINOR_VERSION=10, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  3.2, INSTANCE_NAME=ADC_3_Buffer, )
module OpAmp_P4_v1_10_10 (
    Vplus,
    Vout,
    Vminus);
    inout       Vplus;
...
module top ;
	...
	cy_psoc3_pins_v1_10
		#(.id("b17acd69-1058-444f-b709-aa5d2814d4d2"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
    ...
    DieTemp_P4_v1_0_8 DieTemp (
        .temp(Net_688));

    OpAmp_P4_v1_10_9 ADC_2_Buffer (
        .Vplus(Net_689),
        .Vout(Net_251),
        .Vminus(Net_174));

    OpAmp_P4_v1_10_10 ADC_3_Buffer (
        .Vplus(Net_682),
        .Vout(Net_252),
        .Vminus(Net_730));
    ...
    CapSense_CSD_P4_v2_20_13 CapSense ();
