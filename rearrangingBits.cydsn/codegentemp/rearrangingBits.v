// ======================================================================
// rearrangingBits.v generated from TopDesign.cysch
// 07/09/2015 at 12:17
...
module CapSense_CSD_P4_v2_20_12 ;
...
module top ;
	...
	cy_psoc3_pins_v1_10
		#(.id("61b29eb1-4fc4-47ba-b31c-07bea73ffb97"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
    ...
    OpAmp_P4_v1_10_8 ADC_2_Buffer (
        .Vplus(Net_689),
        .Vout(Net_251),
        .Vminus(Net_174));

    OpAmp_P4_v1_10_9 ADC_3_Buffer (
        .Vplus(Net_682),
        .Vout(Net_252),
        .Vminus(Net_730));
    ...
    CapSense_CSD_P4_v2_20_12 CapSense ();

    SCB_P4_v3_0_13 UART_1 (
        .interrupt(Net_2114),
        .clock(1'b0),
        .rx_tr_out(Net_2116),
        .tx_tr_out(Net_2117));
